...
class Game:
    def __init__(self):
        ...
        self.weapon_tiers = {
            "Rusty": ["Rusty Sword", "Rusty Axe"],
            "Iron": ["Iron Sword", "Iron Axe"],
            "Steel": ["Steel Sword", "Steel Axe"]
        }
